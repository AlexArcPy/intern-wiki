...
`async` returns a Deferred object that can be used to resolve the test once it has completed. In addition to the [standard Deferred API](http://dojotoolkit.org/api/dojo/Deferred), this Deferred object has two additional methods:
