Once you’ve run a test, you need to be able to get information out of Intern into a form that is actually useful to you. This is where Reporters come in. Reporters are modules that use a pub/sub architecture to receive specific messages about the tests being executed.
...
<td>This topic is published whenever an error occurs anywhere within Intern. These errors may be test failures, or they may be more serious errors from outside the test code itself.</td>
</tr>
